...
const NewCategoryPage: React.FC = () => {
  ...
  useEffect(() => {
        if (user?.email) {
          document.title = `New Category | ${user.email}`;
        } 
      }, [user?.email]);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const isMainCategory = !formData.parent_id || formData.parent_id === '';
      const hasImage = formData.image;

      if (isMainCategory && !hasImage) {
  ...
  const getParentOptions = (categories: Category[]): Category[] => {
      ...
      <ProtectedRoute requiredRole="moderator">
        <div className="min-h-screen bg-gray-50 flex items-center justify-center">
          <div className="text-center bg-white p-8 rounded-lg shadow-md max-w-md mx-4">
            ...
            <h2 className="text-xl font-bold text-gray-900 mb-2">Kategori Berhasil Dibuat!</h2>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="bg-white rounded-lg shadow-md p-4 sm:p-6">
              <div className="flex items-center space-x-4">
                ...
                <div className="min-w-0">
                  <h1 className="text-xl sm:text-2xl font-bold text-gray-900">Tambah Kategori Baru</h1>
                  <p className="text-sm sm:text-base text-gray-600">Buat kategori produk baru dengan informasi lengkap</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-md">
            <div className="p-4 sm:p-6 border-b border-gray-200">
              ...
              <p className="text-sm text-gray-600 mt-1">Lengkapi form di bawah untuk membuat kategori baru</p>
            </div>
              ...
              <div className="space-y-6">
                      ...
                      <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
                        <div className="flex items-start">
                          <div className="text-sm">
                            <p className="text-blue-800 font-medium">Info Gambar Kategori</p>
                            <p className="text-blue-700">
                              Kategori utama wajib memiliki gambar untuk ditampilkan di halaman depan. 
                              Ukuran maksimal 20MB dengan format JPG, PNG, atau WebP.
                            </p>
                          </div>
                        </div>
                      </div>
                ...
                {(formData.parent_id && formData.parent_id !== '') && (
                  <div className="bg-green-50 border border-green-200 rounded-lg p-3">
                    <div className="flex items-start">
                      <div className="text-sm">
                        <p className="text-green-800 font-medium">Info Kategori Sub</p>
