...
import { Users, Package, Image, Settings, BarChart3, Shield } from 'lucide-react';
...
const AdminFeatures: React.FC = () => {
  const adminFeatures = [
    ...
    {
      title: 'Keamanan',
      description: 'Log aktivitas, monitoring keamanan, dan kontrol akses',
      icon: Shield,
    ...
    <div className="space-y-6">
      <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg p-6 border border-blue-200">
        ...
        <p className="text-blue-700 text-sm">
          Selamat datang di panel admin. Anda memiliki akses penuh untuk mengelola sistem dan pengguna.
        </p>
      </div>
      ...
      {}
      <div className="bg-white rounded-lg border border-gray-200 p-6">
        <h4 className="text-sm font-semibold text-gray-900 mb-3">Informasi Sistem</h4>
        <div className="space-y-2 text-sm text-gray-600">
          ...
          <div className="flex justify-between">
            ...
            <span className="font-medium text-blue-600">JWT Active</span>
          </div>
          <div className="flex justify-between">
